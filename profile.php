      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="input-group">
            ...
            <input type="text" value="<?php echo $fullName; ?>" class="form-control"></input>
          ...
          <div class="input-group">
            ...
            <input type="date" value="<?php echo $dob; ?>" min="2018-01-01" max="<?php echo date("Y-m-d"); ?>" class="form-control">
